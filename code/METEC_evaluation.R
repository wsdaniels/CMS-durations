# Description: Modified version of the duration estimation code for use on the
#              non-blinded METEC evaluation data. Specifically, this script 
#              includes logic to filter out the multi-source controlled releases.
...
# Set number of sensors to be used. Must be integer between 1 and 8.
z = 8
...
data <- readRDS('../input_data/METEC_forward_model_output.RData')
...
# Optimal sensor arrangements given the sensor budget, z.
# These come from the optimization procedure described in the SI of the 
...
# STEP 9: PLOT ALL EVENTS AND EVENT-LEVEL DURATION DISTRIBUTIONS
#---------------------------------------------------------------------------
...
png(paste0(save.dir, 'METEC_results_', z, '_sensors.png'),
    width = 1920, height = 1000, res = 100, pointsize = 24)
